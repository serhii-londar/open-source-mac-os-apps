...
- [BlackHole](https://github.com/ExistentialAudio/BlackHole) - BlackHole is a modern macOS virtual audio driver that allows applications to pass audio to other applications with zero additional latency. ![c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/ExistentialAudio/BlackHole)
...
- [Suohai](https://github.com/Sunnyyoung/Suohai) - Audio input/output source lock for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Sunnyyoung/Suohai)
...
- [Textual](https://github.com/Codeux-Software/Textual) - Textual is an IRC client for macOS.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Codeux-Software/Textual)
...
- [Sequel Pro](https://github.com/sequelpro/sequelpro) - MySQL/MariaDB database management for macOS.   ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/sequelpro/sequelpro)
...
- [Gitify](https://github.com/manosim/gitify) - Your GitHub notifications on your menu bar. ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/manosim/gitify)
...
- [KubeMonitor](https://github.com/Daniel-Sanche/KubeMonitor) - KubeMonitor is a macOS app that displays information about your active Kubernetes cluster in your menu bar.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Daniel-Sanche/KubeMonitor)
...
- [Cleaner for Xcode](https://github.com/waylybaye/XcodeCleaner) - Cleaner for Xcode.app built with react-native-macOS.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/waylybaye/XcodeCleaner)
...
- [SmartPush](https://github.com/shaojiankui/SmartPush) - iOS Push Notification Debug App.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/shaojiankui/SmartPush)
- [Stringz](https://github.com/mohakapt/Stringz) - A lightweight and powerful editor for localizing iOS, macOS, tvOS, and watchOS applications. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mohakapt/Stringz)
...
- [Quick Look plugins](https://github.com/sindresorhus/quick-look-plugins) - List of useful Quick Look plugins for developers. ![objective_c_icon] ![c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/quick-look-plugins)
...
- [PhotoMiner](https://github.com/gergelysanta/photominer) - macOS app for finding and lost forgotten photos on your disks.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/gergelysanta/photominer)
...
- [Pi Stats](https://github.com/Bunn/PiStats) - macOS app to visualize Pi-hole information. ![swift_icon] ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Bunn/PiStats)
- [PlayStatus](https://github.com/nbolar/PlayStatus) - PlayStatus is a macOS app that allows the control of Spotify and iTunes music playback from the menu bar. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/nbolar/PlayStatus)
...
- [Notenik](https://github.com/hbowie/notenik-swift) - Note-taking app with many organizational options. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/hbowie/notenik-swift)
- [Notes](https://github.com/SauvageP/Notes) - Notes is a macOS application built to create notes, using text amongst other formats: images, videos, contacts, and etc.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/SauvageP/Notes)
- [QOwnNotes](https://github.com/pbek/QOwnNotes) - Plain-text file notepad and todo-list manager with markdown support and ownCloud / Nextcloud integration. ![cpp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/pbek/QOwnNotes)
...
- [RktMachine](https://github.com/woofwoofinc/rktmachine) - Menu bar macOS app for running rkt in a macOS hypervisor CoreOS VM.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/woofwoofinc/rktmachine)
...
- [SelfControl](https://github.com/SelfControlApp/selfcontrol) - macOS app to block your own access to distracting websites etc for a predetermined period of time. It can not be undone by the app or by a restart – you must wait for the timer to run out.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/SelfControlApp/selfcontrol)
- [Sessions](https://github.com/AlexPerathoner/Sessions) - Safari extension to save your working sessions ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/AlexPerathoner/Sessions)
- [Speed Reader](https://github.com/LumingYin/SpeedReader) - Read faster with the power of silencing vocalization with SpeedReader. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/LumingYin/SpeedReader)
- [Spotter](https://github.com/spotter-application/spotter) - Productivity tool, the main function is to search and launch external application actions and applications themselves, so you can stay focused on your current task. Kind of spotlight or alfred alternative. ![type_script_icon] ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/spotter-application/spotter)
- [StickyNotes](https://github.com/LumingYin/StickyNotes) - A Windows 10-esque Sticky Notes app implemented in AppKit. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/LumingYin/StickyNotes)
- [Strategr](https://github.com/khrykin/StrategrDesktop) - No-fuss time management. ![cpp_icon] ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/khrykin/StrategrDesktop)
- [Super Productivity](https://github.com/johannesjo/super-productivity) - Free to do list & time tracker for programmers & designers with Jira integration. ![type_script_icon] ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/johannesjo/super-productivity)
- [ThenGenerator](https://github.com/87kangsw/ThenGenerator) - Xcode Source Editor Extension for 'Then' ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/87kangsw/ThenGenerator)
- [Thyme](https://github.com/joaomoreno/thyme) - The task timer for OS X.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/joaomoreno/thyme)
- [Timer](https://github.com/michaelvillar/timer-app) - Simple Timer app for Mac.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/michaelvillar/timer-app)
- [Toggl Desktop](https://github.com/toggl-open-source/toggldesktop) - Toggl Desktop app for Windows, Mac and Linux.  ![cpp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/toggl-open-source/toggldesktop)
- [TomatoBar](https://github.com/ivoronin/TomatoBar) - Pomodoro Technique Timer for macOS with Touch Bar support. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/ivoronin/TomatoBar)
- [TrelloApp](https://github.com/jlong/TrelloApp) - Unofficial wrapper application for Trello.com written in Swift. This is almost a "Hello World" for a site specific browser.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/jlong/TrelloApp)
- [Ueli](https://github.com/oliverschwendener/ueli) - A keystroke launcher for macOS (and Windows) like Spotlight or Alfred. ![typescript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/oliverschwendener/ueli)
- [Ultra TabSaver](https://github.com/Swift-open-source/UltraTabSaver) - Ultra TabSaver is an open-source Tab Manager for Safari ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Swift-open-source/UltraTabSaver)
- [Watson](https://github.com/TailorDev/Watson) - A CLI application for time tracking.  ![python_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/TailorDev/Watson)
- [Whale](https://github.com/1000ch/whale) - Unofficial Trello app.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/1000ch/whale)
- [Yomu](https://github.com/sendyhalim/Yomu) - Manga reader app for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/sendyhalim/Yomu)
- [espanso](https://github.com/federico-terzi/espanso) - Cross-platform Text Expander, a powerful replacement for Alfred Snippets ![rust_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/federico-terzi/espanso)
- [linked](https://github.com/lostdesign/linked) - 🧾 Your daily journal app, diary or anything else to unclutter your mind. Let linked help you get focused by writing down what is in your mind on a daily basis.  ![javascript_icon] ![vue_icon] ![css_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/lostdesign/linked)
- [macOrganizer](https://github.com/shubhambatra3019/macOrganizer) - macOS app for organizing files or removing unnecessary files.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/shubhambatra3019/macOrganizer)
- [reventlou](https://github.com/b3z/reventlou) - Personal database as an information management system. ![type_script_icon] ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/b3z/reventlou)
- [status-bar-todo](https://github.com/Onix-Systems/osx-status-bar-todo) - Simple macOS app to keep TODO-list in status bar.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Onix-Systems/osx-status-bar-todo)
- [stretchly](https://github.com/hovancik/stretchly) - Cross-platform electron app that reminds you to take breaks when working with computer.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/hovancik/stretchly)

### Screensaver
- [Aerial](https://github.com/JohnCoates/Aerial) - Apple TV Aerial Screensaver for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/JohnCoates/Aerial)
- [Brooklyn](https://github.com/pedrommcarrasco/Brooklyn) - Screensaver inspired by Apple's Event on October 30, 2018.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/pedrommcarrasco/Brooklyn)
- [Epoch Flip Clock Screensaver](https://github.com/chrstphrknwtn/epoch-flip-clock-screensaver) - Unix epoch timestamp flip clock screensaver. ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/chrstphrknwtn/epoch-flip-clock-screensaver)
- [Image-As-Wallpaper](https://github.com/ved62/Image-As-Wallpaper) - Utility application helps with selection of images for using as desktop wallpaper or in screensaver on Mac computers.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/ved62/Image-As-Wallpaper)
- [Irvue](https://github.com/leonspok/Irvue-Screensaver) - Screensaver for macOS.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/leonspok/Irvue-Screensaver)
- [Life Saver](https://github.com/amiantos/lifesaver) - An abstract screensaver based on Conway's Game of Life implemented with SpriteKit ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/amiantos/lifesaver)
- [MinimalClock](https://github.com/mattiarossini/MinimalClock) - Simple and elegant screensaver that displays the time. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mattiarossini/MinimalClock)
- [MusaicFM](https://github.com/docterd/MusaicFM) - iTunes Screensaver Clone for Spotify and Last.fm  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/docterd/MusaicFM)
- [Predator](https://github.com/vpeschenkov/Predator) - A predator-inspired clock screensaver for macOS ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/vpeschenkov/Predator)
- [The GitHub Matrix Screensaver](https://github.com/winterbe/github-matrix-screensaver) - The GitHub Matrix Screensaver for macOS.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/winterbe/github-matrix-screensaver)

### Security
- [Cloaker](https://github.com/spieglt/cloaker) - simple drag-and-drop, password-based file encryption. ![rust_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/spieglt/cloaker)
- [Cryptomator](https://github.com/cryptomator/cryptomator) - Multi-platform transparent client-side encryption of your files in the cloud. ![java_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/cryptomator/cryptomator)
- [LuLu](https://github.com/objective-see/LuLu) - LuLu is macOS firewall application that aims to block unauthorized (outgoing) network traffic.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/objective-see/LuLu)
- [Pareto Security](https://github.com/paretoSecurity/pareto-mac/) - A MenuBar app to automatically audit your Mac for basic security hygiene. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/paretoSecurity/pareto-mac/)
- [Privacy Redirect for Safari](https://github.com/smmr-software/privacy-redirect-safari) - Redirect Twitter, YouTube, Reddit, Google Maps, Google Search, and Google Translate to privacy friendly alternatives. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/smmr-software/privacy-redirect-safari)
- [Swifty](https://github.com/swiftyapp/swifty) - Free and offline password manager.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/swiftyapp/swifty)
- [macOS GateKeeper Helper](https://github.com/wynioux/macOS-GateKeeper-Helper) - Simple macOS GateKeeper script. It helps you to control your GateKeeper. ![shell_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/wynioux/macOS-GateKeeper-Helper)
- [stronghold](https://github.com/alichtman/stronghold) - Easily configure macOS security settings from the terminal.  ![python_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/alichtman/stronghold)

### Sharing Files
- [Deluge](https://github.com/deluge-torrent/deluge) - Lightweight cross-platform BitTorrent client.  ![python_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/deluge-torrent/deluge)
- [NitroShare](https://github.com/nitroshare/nitroshare-desktop) - Transferring files from one device to another ![cpp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/nitroshare/nitroshare-desktop)
- [Rhea](https://github.com/timonus/Rhea) - macOS status bar app for quickly sharing files and URLs.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/timonus/Rhea)
- [Soduto](https://github.com/soduto/Soduto) - Soduto is a KDEConnect compatible application for macOS. It gives AirDrop like integration and allows file and clipboard sharing between your phones, desktops and tablets. ![swift_icon] ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/soduto/Soduto)
- [Transmission](https://github.com/transmission/transmission) - Official Transmission BitTorrent client repository. ![objective_c_icon] ![c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/transmission/transmission)
- [Tribler](https://github.com/Tribler/tribler) - Privacy enhanced BitTorrent client with P2P content discovery.  ![python_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Tribler/tribler)
- [mac2imgur](https://github.com/mileswd/mac2imgur) - Simple Mac app designed to make uploading images and screenshots to Imgur quick and effortless.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mileswd/mac2imgur)
- [qBittorrent](https://github.com/qbittorrent/qBittorrent) - BitTorrent client in Qt.  ![cpp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/qbittorrent/qBittorrent)

### Social Networking
- [Caprine](https://github.com/sindresorhus/caprine#features) - Elegant Facebook Messenger desktop app. ![javascript_icon] ![css_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/caprine#features)
- [Goofy](https://github.com/danielbuechele/goofy) - Unofficial Facebook Messenger client.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/danielbuechele/goofy)
- [Leviathan](https://github.com/Swiftodon/Leviathan) - Leviathan is a iOS and macOS client application for the Mastodon social network.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Swiftodon/Leviathan)
- [Messenger](https://github.com/rsms/fb-mac-messenger) - macOS app wrapping Facebook's Messenger for desktop.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/rsms/fb-mac-messenger)
- [Product Hunt](https://github.com/producthunt/producthunt-osx) - share and discover your favorite new products and applications.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/producthunt/producthunt-osx)
- [Quail](https://github.com/1000ch/quail) - Unofficial [esa](https://esa.io) app.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/1000ch/quail)
- [Ramme](https://github.com/terkelg/ramme) - Unofficial Instagram Desktop App. ![javascript_icon] ![css_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/terkelg/ramme)
- [RedditOS](https://github.com/Dimillian/RedditOS) - A SwiftUI Reddit client for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Dimillian/RedditOS)
- [Simpo](https://github.com/KeliCheng/Simpo) - macOS menubar app to post status quickly.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/KeliCheng/Simpo)

### Streaming
- [Galeri](https://github.com/michealparks/galeri) - Perpetual artwork streaming app.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/michealparks/galeri)
- [OBS Studio](https://github.com/obsproject/obs-studio) - Free and open source software for live streaming and screen recording.  ![cpp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/obsproject/obs-studio)
- [Plug](https://github.com/wulkano/Plug) - Discover and listen to music from Hype Machine. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/wulkano/Plug)

### System
- [AppPolice](https://github.com/AppPolice/AppPolice) - App for macOS with a minimalistic UI which lets you quickly throttle down the CPU usage of any running process.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/AppPolice/AppPolice)
- [Apple Juice](https://github.com/raphaelhanneken/apple-juice) - Advanced battery gauge for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/raphaelhanneken/apple-juice)
- [Clean-Me](https://github.com/Kevin-De-Koninck/Clean-Me) - Small macOS app that acts as a system cleaner (logs, cache, ...).  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Kevin-De-Koninck/Clean-Me)
- [Diagnostics](https://github.com/macmade/Diagnostics) - Diagnostics is an application displaying the diagnostic reports from applications on macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/macmade/Diagnostics)
- [DisableMonitor](https://github.com/Eun/DisableMonitor) - Easily disable or enable a monitor on your Mac.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Eun/DisableMonitor)
- [EtreCheck](https://github.com/etresoft/EtreCheck) - EtreCheck is an easy-to-use macOS app to display important details of your system configuration and allow you to copy that information to the Clipboard.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/etresoft/EtreCheck)
- [Fanny](https://github.com/DanielStormApps/Fanny) - Monitor your Mac's fan speed and CPU temperature from your Notification Center.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/DanielStormApps/Fanny)
- [HoRNDIS](https://github.com/jwise/HoRNDIS) - Android USB tethering driver for macOS.  ![cpp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/jwise/HoRNDIS)
- [Juice](https://github.com/brianmichel/Juice) - Make your battery information a bit more interesting.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/brianmichel/Juice)
- [KeepingYouAwake](https://github.com/newmarcel/KeepingYouAwake) - Prevents your Mac from going to sleep.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/newmarcel/KeepingYouAwake)
- [Latest](https://github.com/mangerlahn/Latest) - Small utility app for macOS that makes sure you know about all the latest updates to the apps you use.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mangerlahn/Latest)
- [Loading](https://github.com/BonzaiThePenguin/Loading) - Simple network activity monitor for macOS.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/BonzaiThePenguin/Loading)
- [Overkill](https://github.com/KrauseFx/overkill-for-mac) - Stop iTunes from opening when you connect your iPhone.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/KrauseFx/overkill-for-mac)
- [ProfileCreator](https://github.com/ProfileCreator/ProfileCreator) - macOS Application to create standard or customized configuration profiles.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/ProfileCreator/ProfileCreator)
- [SlimHUD - Cyanocitta](https://github.com/AlexPerathoner/SlimHUD) - Replacement for MacOS' volume, brightness and keyboard backlight HUDs. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/AlexPerathoner/SlimHUD)
- [Sloth](https://github.com/sveinbjornt/Sloth) - Sloth is an macOS application that displays a list of all open files and sockets in use by all running applications on your system.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/sveinbjornt/Sloth)
- [Spotter](https://github.com/spotter-application/spotter) - Productivity tool, the main function is to search and launch external application actions and applications themselves, so you can stay focused on your current task. Kind of spotlight or alfred alternative. ![type_script_icon] ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/spotter-application/spotter)
- [Stats](https://github.com/exelban/stats) - macOS system monitor in your menu bar ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/exelban/stats)
- [Turbo Boost Switcher](https://github.com/rugarciap/Turbo-Boost-Switcher) - Turbo Boost Switcher is a little application for Mac computers that allows to enable and/or disable the Turbo Boost feature.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/rugarciap/Turbo-Boost-Switcher)
- [VerticalBar](https://github.com/DeromirNeves/VerticalBar) - macOS application to add a vertical bar to Dock.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/DeromirNeves/VerticalBar)
- [eul](https://github.com/gao-sun/eul) - macOS status monitoring app written in SwiftUI. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/gao-sun/eul)
- [macOS GateKeeper Helper](https://github.com/wynioux/macOS-GateKeeper-Helper) - Simple macOS GateKeeper script. It helps you to control your GateKeeper. ![shell_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/wynioux/macOS-GateKeeper-Helper)
- [macOSLucidaGrande](https://github.com/LumingYin/macOSLucidaGrande) - A small utility to set Lucida Grande as your Mac's system UI font. ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/LumingYin/macOSLucidaGrande)

### Terminal
- [Alacritty](https://github.com/alacritty/alacritty) - Cross-platform, GPU-accelerated terminal emulator.  ![rust_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/alacritty/alacritty)
- [Bifrost](https://github.com/ishuah/bifrost) - A tiny terminal emulator for serial port communication (macOS/Linux).  ![go_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/ishuah/bifrost)
- [Console](https://github.com/macmade/Console) - macOS console application.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/macmade/Console)
- [Finder Go](https://github.com/onmyway133/FinderGo) - macOS app and Finder Sync Extension to open Terminal, iTerm, Hyper from Finder.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/onmyway133/FinderGo)
- [Hyper](https://github.com/vercel/hyper) - Terminal built on web technologies. ![javascript_icon] ![css_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/vercel/hyper)
- [Kitty](https://github.com/kovidgoyal/kitty) - Cross-platform, fast, feature full, GPU based terminal emulator. ![python_icon] ![c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/kovidgoyal/kitty)
- [OpenInTerminal](https://github.com/Ji4n1ng/OpenInTerminal) - Finder Toolbar app for macOS to open the current directory in Terminal, iTerm, Hyper or Alacritty. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Ji4n1ng/OpenInTerminal)
- [OpenTerminal](https://github.com/es-kumagai/OpenTerminal) - App for macOS that opens a new Finder window and changes the current directory to the folder launched by the app.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/es-kumagai/OpenTerminal)
- [cd to... ](https://github.com/jbtule/cdto) - Finder Toolbar app to open the current directory in the Terminal ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/jbtule/cdto)
- [iTerm 2](https://github.com/gnachman/iTerm2) - Terminal emulator for macOS that does amazing things.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/gnachman/iTerm2)
- [macOS GateKeeper Helper](https://github.com/wynioux/macOS-GateKeeper-Helper) - Simple macOS GateKeeper script. It helps you to control your GateKeeper. ![shell_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/wynioux/macOS-GateKeeper-Helper)
- [wallpapper](https://github.com/mczachurski/wallpapper) - wallpapper is a console application for creating dynamic wallpapers for Mojave.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mczachurski/wallpapper)

### Touch Bar
- [Muse](https://github.com/xzzz9097/Muse) - Spotify controller with TouchBar support.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/xzzz9097/Muse)
- [MyTouchbarMyRules](https://github.com/toxblh/MTMR) - App to customize your Touch Bar as you want.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/toxblh/MTMR)
- [Pock](https://github.com/pigigaldi/Pock) - Display macOS Dock in Touch Bar. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/pigigaldi/Pock)
- [Touch Bar Preview](https://github.com/touchbar/Touch-Bar-Preview) - Small application to display your designs on the Touch Bar of the new MacBook Pro.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/touchbar/Touch-Bar-Preview)
- [Touch Bar Simulator](https://github.com/sindresorhus/touch-bar-simulator) - Use the Touch Bar on any Mac.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/touch-bar-simulator)
- [Touch Emoji](https://github.com/lessmess-dev/touch-emoji) - Emoji picker for MacBook Pro Touch Bar.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/lessmess-dev/touch-emoji)

### Utilities
- [Android tool for Mac](https://github.com/mortenjust/androidtool-mac) - One-click screenshots, video recordings, app installation for iOS and Android  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mortenjust/androidtool-mac)
- [ArchiveMounter](https://github.com/ivoronin/ArchiveMounter) - Mounts archives like disk images. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/ivoronin/ArchiveMounter)
- [BeardedSpice](https://github.com/beardedspice/beardedspice) - Control web based media players with the media keys found on Mac keyboards.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/beardedspice/beardedspice)
- [Bitwarden](https://github.com/bitwarden/desktop) - Cross-platform password management solutions for individuals, teams, and business organizations.  ![type_script_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/bitwarden/desktop)
- [Bitwarden Menu](https://github.com/jnsdrtlf/bitwarden-menubar) - Bitwarden Passwort Manager in your menu bar ![type_script_icon] ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/jnsdrtlf/bitwarden-menubar)
- [Boop](https://github.com/IvanMathy/Boop) - A scriptable scratchpad for developers. ![swift_icon] ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/IvanMathy/Boop)
- [Buttercup Desktop](https://github.com/buttercup/buttercup-desktop) - Secure password manager for mac and other platforms.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/buttercup/buttercup-desktop)
- [Calculeta](https://github.com/varol/Calculeta) - Calculator for macOS which working on statusbar. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/varol/Calculeta)
- [Catch](https://github.com/mipstian/catch/) - Catch: Broadcatching made easy.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mipstian/catch/)
- [Clear Clipboard Text Format](https://github.com/LumingYin/ClipboardClear) - Easily clear the format of your clipboard text with Clear Clipboard Text Format. ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/LumingYin/ClipboardClear)
- [CoreLocationCLI](https://github.com/fulldecent/corelocationcli) - Get the physical location of your device and prints it to standard output ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/fulldecent/corelocationcli)
- [CornerCal](https://github.com/ekreutz/CornerCal) - Simple, clean calendar and clock app for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/ekreutz/CornerCal)
...
- [DevUtils.app](https://github.com/DevUtilsApp/DevUtils-app) - Developer Utilities for macOS, helps you with your tiny daily tasks with just a single click! i.e., JSON Formatter, UUID Generator... ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/DevUtilsApp/DevUtils-app)
- [Duplicate Finder](https://github.com/powerwolf543/DuplicateFinder) - It's a useful tool that would help you to find all duplicate files which have the same names in the specific folder. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/powerwolf543/DuplicateFinder)
- [ECheck](https://github.com/josejuanqm/ECheck) - Small tool to validate epub files for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/josejuanqm/ECheck)
- [Flying Carpet](https://github.com/spieglt/flyingcarpet) - cross-platform file transfer over ad-hoc wifi, like AirDrop but for Mac/Windows/Linux. ![go_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/spieglt/flyingcarpet)
- [Funky](https://github.com/thecatalinstan/Funky) - Easily toggle the function key on your Mac on a per app basis. ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/thecatalinstan/Funky)
- [Gray](https://github.com/zenangst/Gray) - Pick between the light appearance and the dark appearance on a per-app basis with the click of a button  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/zenangst/Gray)
- [Grayscale Mode](https://github.com/rkbhochalya/grayscale-mode) - Manage grayscale mode from menu bar. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/rkbhochalya/grayscale-mode)
- [Kap](https://github.com/wulkano/kap) - Screen recorder application built with web technology.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/wulkano/kap)
- [KeePassXC](https://github.com/keepassxreboot/keepassxc) - Cross-platform community-driven port of the Windows application "Keepass Password Safe"  ![cpp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/keepassxreboot/keepassxc)
- [KeeWeb](https://github.com/keeweb/keeweb) - Cross-platform password manager compatible with KeePass.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/keeweb/keeweb)
- [Kyapchar](https://github.com/vishaltelangre/Kyapchar) - Simple screen and microphone audio recorder for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/vishaltelangre/Kyapchar)
- [Layout Designer for UICollectionView](https://github.com/amirdew/CollectionViewPagingLayout) - A simple but powerful tool that helps you make complex layouts for UICollectionView. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/amirdew/CollectionViewPagingLayout)
- [Life-Calendar](https://github.com/wvdk/Life-Calendar) - Life Calendar.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/wvdk/Life-Calendar)
- [Lunar](https://github.com/alin23/lunar) - Intelligent adaptive brightness for your external displays.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/alin23/lunar)
- [MQTTX](https://github.com/emqx/MQTTX) - An elegant Cross-platform MQTT 5.0 desktop client. ![javascript_icon] ![type_script_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/emqx/MQTTX)
- [MacPass](https://github.com/MacPass/MacPass) - Native macOS KeePass client.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/MacPass/MacPass)
- [Maria](https://github.com/shincurry/Maria) - macOS native app/widget for aria2 download tool.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/shincurry/Maria)
- [MeetingBar](https://github.com/leits/MeetingBar) - Menu bar app for your calendar meetings ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/leits/MeetingBar)
- [Meme Maker](https://github.com/MemeMaker/Meme-Maker-Mac) - Meme Maker macOS application for meme creation.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/MemeMaker/Meme-Maker-Mac)
- [Middleclick](https://github.com/DaFuqtor/MiddleClick-Catalina) - Emulate a scroll wheel click with three finger Click or Tap on MacBook trackpad and Magic Mouse ![c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/DaFuqtor/MiddleClick-Catalina)
- [MonitorControl](https://github.com/MonitorControl/MonitorControl) - Control your external monitor brightness, contrast or volume directly from a menulet or with keyboard native keys. ![swift_icon] ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/MonitorControl/MonitorControl)
- [Monolingual](https://github.com/IngmarStein/Monolingual) - Remove unnecessary language resources from macOS  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/IngmarStein/Monolingual)
- [Mos](https://github.com/Caldis/Mos) - Smooth your mouse's scrolling and reverse the mouse scroll direction  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Caldis/Mos)
- [Music Bar](https://github.com/musa11971/Music-Bar/) - Music Bar is macOS application that places music controls right in your menu bar. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/musa11971/Music-Bar/)
- [Nocturnal](https://github.com/joshjon/nocturnal) - Menu bar app featuring darker than dark dimming, Night Shift fine tuning, and the ability to turn off TouchBar on MacBook Pro.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/joshjon/nocturnal)
- [NoiseBuddy](https://github.com/insidegui/NoiseBuddy) - Control the listening mode on your AirPods Pro in the Touch Bar or Menu Bar. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/insidegui/NoiseBuddy)
- [Noti](https://github.com/jariz/Noti/) - Receive Android notifications on your mac (with PushBullet).  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/jariz/Noti/)
- [PB for Desktop](https://github.com/sidneys/pb-for-desktop) - Receive native push notifications on macOS, Windows and Linux.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/sidneys/pb-for-desktop)
- [Padlock](https://github.com/padloc/padloc) - A minimal, open source password manager for macOS.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/padloc/padloc)
- [PercentCalculator](https://github.com/cemolcay/PercentCalculator) - A menu bar application that calculates parcents.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/cemolcay/PercentCalculator)
- [Plain Pasta](https://github.com/hisaac/PlainPasta) - Plaintextify your clipboard ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/hisaac/PlainPasta)
- [PlayStatus](https://github.com/nbolar/PlayStatus) - PlayStatus is a macOS app that allows the control of Spotify and iTunes music playback from the menu bar. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/nbolar/PlayStatus)
- [PowerShell](https://github.com/powershell/powershell) - PowerShell is a cross-platform automation and configuration tool/framework that works well with your existing tools. ![c_sharp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/powershell/powershell)
- [ScreenCat](https://github.com/maxogden/screencat) - ScreenCat is a screen sharing + remote collaboration application. ![javascript_icon] ![css_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/maxogden/screencat)
- [SlimHUD - Cyanocitta](https://github.com/AlexPerathoner/SlimHUD) - Replacement for MacOS' volume, brightness and keyboard backlight HUDs. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/AlexPerathoner/SlimHUD)
- [SlowQuitApps](https://github.com/dteoh/SlowQuitApps) - Add a global delay to Command-Q to stop accidental app quits.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/dteoh/SlowQuitApps)
- [Spotter](https://github.com/spotter-application/spotter) - Productivity tool, the main function is to search and launch external application actions and applications themselves, so you can stay focused on your current task. Kind of spotlight or alfred alternative. ![type_script_icon] ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/spotter-application/spotter)
- [Stats](https://github.com/exelban/stats) - macOS system monitor in your menu bar ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/exelban/stats)
- [Stringz](https://github.com/mohakapt/Stringz) - A lightweight and powerful editor for localizing iOS, macOS, tvOS, and watchOS applications. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mohakapt/Stringz)
- [Super Productivity](https://github.com/johannesjo/super-productivity) - Free to do list & time tracker for programmers & designers with Jira integration. ![type_script_icon] ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/johannesjo/super-productivity)
- [Telephone](https://github.com/64characters/Telephone) - SIP softphone for macOS. ![objective_c_icon] ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/64characters/Telephone)
- [The Blockstack Browser](https://github.com/blockstack/blockstack-browser) - Blockstack is an internet for decentralized apps where users own their data. The Blockstack Browser allows you to explore the Blockstack internet.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/blockstack/blockstack-browser)
- [ThenGenerator](https://github.com/87kangsw/ThenGenerator) - Xcode Source Editor Extension for 'Then' ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/87kangsw/ThenGenerator)
- [ToTheTop](https://github.com/zenangst/ToTheTop) - Small macOS application to help you scroll to the top.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/zenangst/ToTheTop)
- [Ultra TabSaver](https://github.com/Swift-open-source/UltraTabSaver) - Ultra TabSaver is an open-source Tab Manager for Safari ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Swift-open-source/UltraTabSaver)
- [baRSS – Menu Bar RSS Reader](https://github.com/relikd/barss) - RSS & Atom feed reader that lives in the system status bar. ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/relikd/barss)
- [calibre](https://github.com/kovidgoyal/calibre) - cross platform e-book manager. ![python_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/kovidgoyal/calibre)
- [eul](https://github.com/gao-sun/eul) - macOS status monitoring app written in SwiftUI. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/gao-sun/eul)
- [fselect](https://github.com/jhspetersson/fselect) - Command-line tool to search files with SQL syntax. ![rust_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/jhspetersson/fselect)
- [homebrew-cask](https://github.com/Homebrew/homebrew-cask) - A CLI workflow for the administration of macOS applications distributed as binaries ![ruby_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Homebrew/homebrew-cask)
- [iOScanX](https://github.com/alessiomaffeis/iOScanX) - Cocoa application for semi-automated iOS app analysis and evaluation. ![objective_c_icon] ![c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/alessiomaffeis/iOScanX)
- [mac-sound-fix](https://github.com/dragstor/mac-sound-fix) - Mac Sound Re-Enabler.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/dragstor/mac-sound-fix)
- [macOS GateKeeper Helper](https://github.com/wynioux/macOS-GateKeeper-Helper) - Simple macOS GateKeeper script. It helps you to control your GateKeeper. ![shell_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/wynioux/macOS-GateKeeper-Helper)
- [wechsel](https://github.com/friedrichweise/wechsel) - manage bluetooth connections with your keyboard. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/friedrichweise/wechsel)
- [Übersicht](https://github.com/felixhageloh/uebersicht) - Keep an eye on what's happening on your machine and in the world.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/felixhageloh/uebersicht)

### VPN & Proxy
- [ShadowsocksX-NG](https://github.com/shadowsocks/ShadowsocksX-NG) - Next Generation of ShadowsocksX.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/shadowsocks/ShadowsocksX-NG)
- [Specht](https://github.com/zhuhaow/Specht) - Rule-based proxy app built with Network Extension for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/zhuhaow/Specht)
- [SpechtLite](https://github.com/zhuhaow/SpechtLite) - Rule-based proxy app for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/zhuhaow/SpechtLite)
- [Tunnelblick](https://github.com/Tunnelblick/Tunnelblick) - Tunnelblick is a graphic user interface for OpenVPN on macOS.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Tunnelblick/Tunnelblick)
- [clashX](https://github.com/yichengchen/clashX) - A rule based custom proxy with GUI for Mac base on clash.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/yichengchen/clashX)
- [rvc-mac](https://github.com/riboseinc/cryptode-mac) - Ribose VPN Client macOS Menu App.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/riboseinc/cryptode-mac)

### Video
- [Acid.Cam.v2.OSX](https://github.com/lostjared/Acid.Cam.v2.OSX) - Acid Cam v2 for macOS distorts video to create art.  ![cpp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/lostjared/Acid.Cam.v2.OSX)
- [AppleEvents](https://github.com/insidegui/AppleEvents) - Unofficial Apple Events app for macOS.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/insidegui/AppleEvents)
- [Conferences.digital](https://github.com/zagahr/Conferences.digital) - Best way to watch the latest and greatest videos from your favourite developer conferences for free on your Mac. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/zagahr/Conferences.digital)
- [Datamosh](https://github.com/maelswarm/Datamosh) - Datamosh your videos on macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/maelswarm/Datamosh)
- [Face Data](https://github.com/xiaohk/FaceData) - macOS application used to auto-annotate landmarks from a video.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/xiaohk/FaceData)
- [GNU Gatekeeper](https://github.com/willamowius/gnugk) - Video conferencing server for H.323 terminals.  ![cpp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/willamowius/gnugk)
- [Gifted](https://github.com/vdel26/gifted) - Turn any short video into an animated GIF quickly and easily.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/vdel26/gifted)
- [HandBrake](https://github.com/HandBrake/HandBrake) - HandBrake is a video transcoder available for Linux, Mac, and Windows.  ![c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/HandBrake/HandBrake)
- [LosslessCut](https://github.com/mifi/lossless-cut) - The swiss army knife of lossless video/audio editing without re-encoding. ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mifi/lossless-cut)
- [MPV](https://github.com/mpv-player/mpv) - Lightweight, highly configurable media player. ![c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mpv-player/mpv)
- [MenuTube](https://github.com/edanchenkov/MenuTube) - Catch YouTube into your macOS menu bar!  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/edanchenkov/MenuTube)
- [OpenShot](https://github.com/OpenShot/openshot-qt) - Easy to use, quick to learn, and surprisingly powerful video editor.  ![python_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/OpenShot/openshot-qt)
- [Quick Caption](https://github.com/LumingYin/Caption) - Transcribe and generate caption files (SRT, ASS and FCPXML) without manually entering time codes. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/LumingYin/Caption)
- [QuickLook Video](https://github.com/Marginal/QLVideo) - This package allows macOS Finder to display thumbnails, static QuickLook previews, cover art and metadata for most types of video files.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Marginal/QLVideo)
- [Subler](https://bitbucket.org/galad87/subler/src) - Subler is an macOS app created to mux and tag mp4 files.  ![objective_c_icon] 
- [VLC](https://github.com/videolan/vlc) -  VLC is a free and open source cross-platform multimedia player ![c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/videolan/vlc)
- [Vid Quiz Creator](https://github.com/sahil-a/vidquizcreator) - macOS application to insert quizzes within video playback and play those videos to receiving devices using the LISNR API.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/sahil-a/vidquizcreator)
- [WebTorrent Desktop](https://github.com/webtorrent/webtorrent-desktop) - Streaming torrent app. For Mac, Windows, and Linux.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/webtorrent/webtorrent-desktop)
- [Yoda](https://github.com/whoisandy/yoda) - Nifty macOS application which enables you to browse and download videos from YouTube.  ![javascript_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/whoisandy/yoda)

### Wallpaper
- [500-mac-wallpaper](https://github.com/markcheeky/500-mac-wallpaper) - Simple macOS app for the status bar to automatically download photos from 500px.com to a local folder that can be set as a source of wallpapers.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/markcheeky/500-mac-wallpaper)
- [ArtWall](https://github.com/JustinFincher/ASWP-for-macOS) - ArtStation set as wallpapers from [artwork.rss](https://www.artstation.com/community/channels).  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/JustinFincher/ASWP-for-macOS)
- [Artify](https://github.com/NghiaTranUIT/artify-macos) - A macOS application for bringing dedicatedly 18th century Arts to everyone  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/NghiaTranUIT/artify-macos)
- [BingPaper](https://github.com/pengsrc/BingPaper) - Use Bing daily photo as your wallpaper on macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/pengsrc/BingPaper)
- [Desktop Wallpaper Switcher](https://github.com/VioletGiraffe/desktop-wallpaper-switcher) - Win / Linux / macOS tool for managing and cycling desktop wallpapers.  ![cpp_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/VioletGiraffe/desktop-wallpaper-switcher)
- [Muzei](https://github.com/naman14/Muzei-macOS) - Muzei wallpaper app for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/naman14/Muzei-macOS)
- [Plash](https://github.com/sindresorhus/Plash) - Make any website your desktop wallpaper. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/Plash)
- [Satellite Eyes](https://github.com/tomtaylor/satellite-eyes) - macOS app to automatically set your desktop wallpaper to the satellite view overhead.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/tomtaylor/satellite-eyes)
- [Sunscreen](https://github.com/davidcelis/Sunscreen) - Sunscreen is a fun, lightweight application that changes your desktop wallpaper based on sunrise and sunset.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/davidcelis/Sunscreen)
- [WallpaperMenu](https://github.com/diogosantos/WallpaperMenu) - macOS menubar application for navigation through beautiful pictures on the web and set them up as your desktop image.  ![ruby_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/diogosantos/WallpaperMenu)
- [pyDailyChanger](https://github.com/IngoMeyer441/pyDailyChanger) - pyDailyChanger is a program that changes your wallpaper daily.  ![python_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/IngoMeyer441/pyDailyChanger)

### Window Management
- [AltTab](https://github.com/lwouis/alt-tab-macos) - AltTab brings the power of Windows alt-tab to macOS. ![swift_icon] ![shell_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/lwouis/alt-tab-macos)
- [Amethyst](https://github.com/ianyh/Amethyst) - Automatic tiling window manager for macOS.  ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/ianyh/Amethyst)
- [AppGrid](https://github.com/mjolnirapp/AppGrid) - Grid-based keyboard window manager for macOS.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mjolnirapp/AppGrid)
- [Desktop Profiles](https://github.com/mamiksik/Desktop-Profiles) - An innovative desktop/window manager for macOS ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/mamiksik/Desktop-Profiles)
- [Hammerspoon](https://github.com/Hammerspoon/hammerspoon) - Staggeringly powerful macOS desktop automation with Lua. ![lua_icon] ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/Hammerspoon/hammerspoon)
- [Phoenix](https://github.com/kasper/phoenix) - Lightweight macOS window and app manager scriptable with JavaScript.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/kasper/phoenix)
- [Rectangle](https://github.com/rxhanson/Rectangle) - Rectangle is a window manager heavily based on Spectacle, written in Swift. ![swift_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/rxhanson/Rectangle)
- [ShiftIt](https://github.com/fikovnik/ShiftIt) - Managing windows size and position.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/fikovnik/ShiftIt)
- [Slate](https://github.com/jigish/slate) - Slate is a window management application similar to Divvy and SizeUp ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/jigish/slate)
- [Spectacle](https://github.com/eczarny/spectacle) - Spectacle allows you to organize your windows without using a mouse.  ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/eczarny/spectacle)
- [Yabai](https://github.com/koekeishiya/yabai) - A tiling window manager for macOS based on binary space partitioning. ![c_icon] ![objective_c_icon]  ![GitHub last commit](https://img.shields.io/github/last-commit/koekeishiya/yabai)
