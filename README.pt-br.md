...
- [Tickeys](https://github.com/yingDev/Tickeys) - Feedback de áudio instantâneo para digitação. versão macOS.  ![rust_icon] 
...
- [Board For GitHub](https://github.com/JustinFincher/BoardForGitHub) - Pequeno aplicativo para monitorar a página da Web do seu projeto GitHub em um aplicativo macOS nativo :octocat:!  ![objective_c_icon] 
...
- [iOS Images Extractor](https://github.com/devcxm/iOS-Images-Extractor) - iOS Images Extractor é um aplicativo para Mac para normalizar, decodificar e extrair imagens de aplicativos iOS.  ![objective_c_icon] 
...
- [PlayStatus](https://github.com/nbolar/PlayStatus) - PlayStatus é um app para macOS que permite controlar a reprodução de músicas do Spotify e iTunes a partir da barra de menu. ![swift_icon] 
- [Plug](https://github.com/wulkano/Plug) - Descubra e ouça músicas do Hype Machine. ![swift_icon] 
- [SoundCleod](https://github.com/salomvary/soundcleod) - SoundCloud para macOS e Windows.  ![javascript_icon] 
...
- [Paperless Desktop](https://github.com/thomasbrueggemann/paperless-desktop) - Aplicativo de desktop que usa a API sem papel para gerenciar suas digitalizações de documentos. ![javascript_icon]
- [Pennywise](https://github.com/kamranahmedse/pennywise) - Pennywise abre qualquer site ou mídia em uma pequena janela flutuante que permanece no topo de todos os outros aplicativos. É uma ótima alternativa ao Helium. ![javascript_icon]
...
- [macOrganizer](https://github.com/shubhambatra3019/macOrganizer) - Aplicativo macOS para organizar arquivos ou remover arquivos desnecessários. ![swift_icon]
- [reventlou](https://github.com/b3z/reventlou) - Banco de dados pessoal como um sistema de gerenciamento de informações. ![typescript_icon] ![swift_icon]
- [sqlectron](https://github.com/sqlectron/sqlectron-gui) - Um desktop/terminal de cliente SQL simples e leve com banco de dados cruzado e suporte de plataforma. ![typescript_icon]
...
- [EtreCheck](https://github.com/etresoft/EtreCheck) - EtreCheck é um aplicativo macOS fácil de usar para exibir detalhes importantes da configuração do sistema e permitir que você copie essas informações para a área de transferência. ![objective_c_icon]
...
- [OpenInTerminal](https://github.com/Ji4n1ng/OpenInTerminal) - Aplicativo Finder Toolbar para macOS para abrir o diretório atual no Terminal, iTerm, Hyper ou Alacritty. ![swift_icon]
- [OpenTerminal](https://github.com/es-kumagai/OpenTerminal) - Aplicativo para macOS que abre uma nova janela do Finder e altera o diretório atual para a pasta iniciada pelo aplicativo. ![swift_icon]
- [cd to... ](https://github.com/jbtule/cdto) - Aplicativo Finder Toolbar para abrir o diretório atual no Terminal![objective_c_icon]
...
### VPN & Proxy
- [ShadowsocksX-NG](https://github.com/shadowsocks/ShadowsocksX-NG) - Próxima geração de ShadowsocksX. ![swift_icon]
- [Specht](https://github.com/zhuhaow/Specht) - Aplicativo de proxy baseado em regras criado com extensão de rede para macOS. ![swift_icon]
- [SpechtLite](https://github.com/zhuhaow/SpechtLite) - Aplicativo de proxy baseado em regras para macOS. ![swift_icon]
- [Tunnelblick](https://github.com/Tunnelblick/Tunnelblick) - Tunnelblick é uma interface gráfica do usuário para OpenVPN no macOS. ![objective_c_icon]
- [clashX](https://github.com/yichengchen/clashX) - Um proxy personalizado baseado em regras com GUI para Mac baseado em confronto. ![swift_icon]
- [rvc-mac](https://github.com/riboseinc/cryptode-mac) - Ribose VPN Client macOS Menu App.  ![swift_icon] 

### Vídeo
- [Acid.Cam.v2.OSX](https://github.com/lostjared/Acid.Cam.v2.OSX) - Acid Cam v2 para macOS distorce o vídeo para criar arte. ![cpp_icon]
- [AppleEvents](https://github.com/insidegui/AppleEvents) - Aplicativo não oficial de eventos da Apple para macOS. ![objective_c_icon]
- [Conferences.digital](https://github.com/zagahr/Conferences.digital) - A melhor maneira de assistir aos melhores e mais recentes vídeos de suas conferências de desenvolvedores favoritas gratuitamente em seu Mac. ![swift_icon]
- [Datamosh](https://github.com/maelswarm/Datamosh) - Datamosh seus vídeos no macOS. ![swift_icon]
- [Face Data](https://github.com/xiaohk/FaceData) - aplicativo macOS usado para anotar automaticamente pontos de referência de um vídeo. ![swift_icon]
- [GNU Gatekeeper](https://github.com/willamowius/gnugk) - Servidor de videoconferência para terminais H.323. ![cpp_icon]
- [Gifted](https://github.com/vdel26/gifted) - Transforme qualquer vídeo curto em um GIF animado de forma rápida e fácil. ![objective_c_icon]
- [HandBrake](https://github.com/HandBrake/HandBrake) - HandBrake é um transcodificador de vídeo disponível para Linux, Mac e Windows. ![c_icon]
- [LosslessCut](https://github.com/mifi/lossless-cut) - O canivete suíço da edição de vídeo/áudio sem perdas sem recodificação. ![javascript_icon]
- [MPV](https://github.com/mpv-player/mpv) - Reprodutor de mídia leve e altamente configurável. ![c_icon]
- [MenuTube](https://github.com/edanchenkov/MenuTube) - Acesse o YouTube na barra de menus do macOS! ![javascript_icon]
- [OpenShot](https://github.com/OpenShot/openshot-qt) - Editor de vídeo fácil de usar, rápido de aprender e surpreendentemente poderoso. ![python_icon]
- [Quick Caption](https://github.com/LumingYin/Caption) - Transcreva e gere arquivos de legenda (SRT, ASS e FCPXML) sem inserir códigos de tempo manualmente. ![swift_icon]
- [QuickLook Video](https://github.com/Marginal/QLVideo) - Este pacote permite que o macOS Finder exiba miniaturas, visualizações estáticas do QuickLook, arte da capa e metadados para a maioria dos tipos de arquivos de vídeo. ![objective_c_icon]
- [Subler](https://bitbucket.org/galad87/subler/src) - Subler é um aplicativo macOS criado para mux e marcar arquivos mp4. ![objective_c_icon]
- [VLC](https://github.com/videolan/vlc) - VLC é um reprodutor multimídia multiplataforma gratuito e de código aberto ![c_icon]
- [Vid Quiz Creator](https://github.com/sahil-a/vidquizcreator) - aplicativo macOS para inserir questionários na reprodução de vídeo e reproduzi-los em dispositivos receptores usando a API LISNR. ![swift_icon]
- [WebTorrent Desktop](https://github.com/webtorrent/webtorrent-desktop) - Aplicativo de streaming de torrent. Para Mac, Windows e Linux. ![javascript_icon]
- [Yoda](https://github.com/whoisandy/yoda) - Aplicativo bacana para macOS que permite navegar e baixar vídeos do YouTube.  ![javascript_icon] 
